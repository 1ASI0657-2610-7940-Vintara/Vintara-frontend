...
import { useInventoryAlerts } from '@/inventory/presentation/composables/useInventoryAlerts'
...
const handleChangePassword = async () => {
  ...
  const result = await profilesStore.changePassword({
